...
const filters = [
  {
    title: "Product Brand",
    options: ["Custom Furniture", "Fusion Dot High Fashion" , "Unique Furnitture Restor" , "Dream Furnitture Flipping","Young Repurposed","Green DIY furniture"],
  },
  { title: "Discount Offer", options: ["20% Cashback", "50% Discount Offer","25% Cashback"] },
  { title: "Rating Item", options: ["★★★★☆ & 2341", "★★★☆☆ & 1726" ,"★★★☆☆ & 258" , "★★★☆☆ & 25"] },
  { title: "Categories", options: ["Prestashop","Magento","Bigcommerce","osCommerce","3dcart","Bags","Accessories","Jewellery","Watches"] },
  { title: "Price Filter", options: ["₹500-₹1000", "₹1000-₹1500", "₹1500+","$450.00 +"] },
  { title: "Filter By Color", options: ["Blue", "Orange", "Brown" , "Green" , "Purple" , "Sky"] },
];
...
export default function Home() {
  return (
    ...
    <div className="flex justify-center p-6">
      <div className="w-full max-w-screen-lg grid grid-cols-4 gap-10">
        {/* Sidebar */}
